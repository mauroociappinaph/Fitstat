...
const MilestoneTimeline: React.FC<Props> = ({ predictions, profile, currentWeight }) => {
  const milestones = useMemo(() => {
    ...
    // 6. Meta Final
    // Estimamos fecha final basada en pérdida de 0.5kg/semana si no hay predicción 90d
